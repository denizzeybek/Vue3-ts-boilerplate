<template>
  <main class="flex items-center justify-center w-screen h-screen text-center">
    <Col :xs="20" :sm="16" :md="12" :lg="10" :xl="8" :xxl="6">
      <TypographyTitle :level="3">Sign in to your account</TypographyTitle>
...
import { Form, Button, Col, TypographyTitle } from 'ant-design-vue'
